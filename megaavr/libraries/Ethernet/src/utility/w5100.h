...
// WazamonoCore (AVR DU, modern AVR):
...
//  bit - verified on an AVR64DU32 board + W5100 Ethernet shield), while 6 MHz and
...
//  code path; see megaavr/extras/WazamonoTsurugi.md (SPI section).
...
private:
#if defined(ARDUINO_ARCH_MEGAAVR)
	// WazamonoCore: modern AVR PORT has OUTSET/OUTCLR right after OUT
