...
| Pro Micro (5.0V) | ATmega32U4 | 16 | 17,208.020 | -(動作せず) | 12556 ms |
| Pro Micro (3.3V) | ATmega32U4 | 8 | 8,564.18 | -(動作せず) | 25244 ms|
| Pro Micro (3.3V) | RP2040(Philhower 6.0.0) | 133 | 295,866.92(Runs x10) | 254.94 | 1523 ms |
| UIAPduino (5.0V) | CH32V003 | 48 | -(書き込み不可) | -(書き込み不可) | -(書き込み不可) |
